...
KeyboardMappingsCollection::KeyboardMappingsCollection() :
    ConfigurationResourceCollection(Serialization::Resources::keyboardMappings) {}

void KeyboardMappingsCollection::deserializeResources(const SerializedData &tree, Resources &outResources)
{
