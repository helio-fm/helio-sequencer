...
static String transformXmlTag(const String &tagOrAttribute)
{
    ...
    static FlatHashMap<String, Identifier, StringHash> oldKeys;
    if (oldKeys.size() == 0)
    {
        oldKeys["ProjectInfo"] = Core::projectInfo;
        oldKeys["ProjectTimeline"] = Core::projectTimeline;
        oldKeys["ProjectLicense"] = ProjectInfoDeltas::projectLicense;
        oldKeys["ProjectFullName"] = ProjectInfoDeltas::projectTitle;
        oldKeys["ProjectAuthor"] = ProjectInfoDeltas::projectAuthor;
        oldKeys["ProjectDescription"] = ProjectInfoDeltas::projectDescription;
        oldKeys["LayerPath"] = MidiTrackDeltas::trackPath;
        oldKeys["LayerColour"] = MidiTrackDeltas::trackColour;
        oldKeys["LayerInstrument"] = MidiTrackDeltas::trackInstrument;
        oldKeys["LayerController"] = MidiTrackDeltas::trackController;
        oldKeys["HeadIndex"] = snapshot;
        oldKeys["HeadIndexData"] = snapshotData;
        oldKeys["annotationsId"] = Core::annotationsTrackId;
        oldKeys["keySignaturesId"] = Core::keySignaturesTrackId;
        oldKeys["timeSignaturesId"] = Core::timeSignaturesTrackId;
        oldKeys["fullPath"] = Core::filePath;
        oldKeys["Path"] = Core::filePath;
        oldKeys["Uuid"] = Audio::instrumentId;
        oldKeys["Uid"] = Audio::pluginId;
        oldKeys["PluginManager"] = Audio::pluginsList;
        oldKeys["Pack"] = pack;
        oldKeys["VCSUuid"] = vcsItemId;
        oldKeys["GlobalConfig"] = Core::globalConfig;
        oldKeys["Layer"] = Core::track;
        oldKeys["PianoLayer"] = Core::pianoTrack;
        oldKeys["AutoLayer"] = Core::automationTrack;
        oldKeys["VersionControl"] = Core::versionControl;
        oldKeys["SourceNode"] = Audio::sourceNodeId;
        oldKeys["DestinationNode"] = Audio::destinationNodeId;
        oldKeys["SourceChannel"] = Audio::sourceChannel;
        oldKeys["DestinationChannel"] = Audio::destinationChannel;
        oldKeys["srcFilter"] = Audio::sourceNodeId;
        oldKeys["dstFilter"] = Audio::destinationNodeId;
        oldKeys["srcChannel"] = Audio::sourceChannel;
        oldKeys["dstChannel"] = Audio::destinationChannel;
        oldKeys["uiLastX"] = UI::positionX;
        oldKeys["uiLastY"] = UI::positionY;
    }
