...
LightShadowDownwards::LightShadowDownwards()
{
...
void LightShadowDownwards::paint (Graphics& g)
{
...
void LightShadowDownwards::resized()
{
...
<JUCER_COMPONENT documentType="Component" className="LightShadowDownwards" template="../../Template"
