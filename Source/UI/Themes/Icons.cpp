...
Image Icons::findByName(const String &name, int maxSize)
{
    ...
    const Colour iconBaseColour(App::Helio()->getTheme()->findColour(ColourIDs::Icons::iconColourId));
    const Colour iconShadeColour(App::Helio()->getTheme()->findColour(ColourIDs::Icons::iconShadowColourId));
...
Image Icons::findByName(const String &name, int maxSize, LookAndFeel &lf)
{
    ...
    const Colour iconBaseColour(lf.findColour(ColourIDs::Icons::iconColourId));
    const Colour iconShadeColour(lf.findColour(ColourIDs::Icons::iconShadowColourId));
    Image prerenderedImage = renderVector(name, fixedSize, iconBaseColour, iconShadeColour);
    return prerenderedImage;
}
