...
void ShadeDark::paint (Graphics& g)
{
    //[UserPrePaint] Add your own custom painting code here..
    //[/UserPrePaint]

    g.fillAll (Colour (0x13000000));

    //[UserPaint] Add your own custom painting code here..
    //[/UserPaint]
}

void ShadeDark::resized()
{
...
<JUCER_COMPONENT documentType="Component" className="ShadeDark" template="../../Template"
                 componentName="" parentClasses="public Component" constructorParams=""
                 variableInitialisers="" snapPixels="8" snapActive="1" snapShown="1"
                 overlayOpacity="0.330" fixedSize="1" initialWidth="256" initialHeight="256">
  <BACKGROUND backgroundColour="13000000"/>
