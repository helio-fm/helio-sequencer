...
LighterShadowUpwards::LighterShadowUpwards()
{
...
void LighterShadowUpwards::paint (Graphics& g)
{
...
void LighterShadowUpwards::resized()
{
...
<JUCER_COMPONENT documentType="Component" className="LighterShadowUpwards" template="../../Template"
                 componentName="" parentClasses="public Component" constructorParams=""
                 variableInitialisers="" snapPixels="8" snapActive="1" snapShown="1"
                 overlayOpacity="0.330" fixedSize="1" initialWidth="600" initialHeight="40">
  <BACKGROUND backgroundColour="ffffff">
    <RECT pos="0 0 0M 0M" fill="linear: 0 0R, 0 0, 0=9000000, 1=0" hasStroke="0"/>
    <RECT pos="0 0Rr 0M 50%" fill="linear: 0 0R, 0 50%, 0=9000000, 1=0"
          hasStroke="0"/>
  </BACKGROUND>
</JUCER_COMPONENT>
