...
LightShadowLeftwards::LightShadowLeftwards()
{
...
void LightShadowLeftwards::paint (Graphics& g)
{
    ...
    g.setGradientFill (ColourGradient (Colour (0x15000000),
                                       ...
                                       false));
    g.fillRect (getWidth() - proportionOfWidth (0.5000f), 0, proportionOfWidth (0.5000f), getHeight() - 0);

    //[UserPaint] Add your own custom painting code here..
    g.setColour(this->findColour(ColourIDs::Common::resizerShadowColourId));
    g.drawVerticalLine(this->getWidth() - 1, 0.f, float(this->getHeight()));
    //[/UserPaint]
}

void LightShadowLeftwards::resized()
{
...
<JUCER_COMPONENT documentType="Component" className="LightShadowLeftwards" template="../../Template"
