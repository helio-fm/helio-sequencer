...
AuthorizationSettings::AuthorizationSettings()
{
    ...
    authorLabel->setColour (Label::textColourId, Colour (0x77ffffff));
    ...
    passwordEditor->setColour (Label::textColourId, Colours::white);
    passwordEditor->setColour (TextEditor::textColourId, Colours::black);
    passwordEditor->setColour (TextEditor::backgroundColourId, Colour (0x00000000));
...
<JUCER_COMPONENT documentType="Component" className="AuthorizationSettings" template="../../Template"
  ...
  <LABEL name="emailEditor" id="9c63b5388edfe183" memberName="emailEditor"
         ...
         posRelativeY="e96b77baef792d3a" textCol="ffffffff" edTextCol="ff000000"
  ...
  <LABEL name="" id="fd5279a09ac6b052" memberName="passwordEditor" virtualName=""
         ...
         textCol="ffffffff" edTextCol="ff000000" edBkgCol="0" labelText="dialog::auth::defaultlogin::mobile"
