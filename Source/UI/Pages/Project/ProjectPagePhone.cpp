...
void ProjectPagePhone::resized()
{
    ...
    projectTitleEditor->setBounds ((getWidth() / 2) + -100, proportionOfHeight (0.0552f) + 2, 350, 34);
    projectTitleLabel->setBounds ((getWidth() / 2) + -104 - 202, proportionOfHeight (0.0552f) + 7, 202, 24);
    authorEditor->setBounds ((getWidth() / 2) + -100, proportionOfHeight (0.0552f) + 48, 350, 34);
    authorLabel->setBounds ((getWidth() / 2) + -104 - 202, proportionOfHeight (0.0552f) + 54, 202, 24);
    descriptionEditor->setBounds ((getWidth() / 2) + -100, proportionOfHeight (0.0552f) + 94, 350, 34);
    descriptionLabel->setBounds ((getWidth() / 2) + -104 - 202, proportionOfHeight (0.0552f) + 100, 202, 24);
    contentStatsLabel->setBounds ((getWidth() / 2) + -104 - 202, (proportionOfHeight (0.0552f) + 175) + 72, 202, 24);
    contentStatsText->setBounds ((getWidth() / 2) + -100, (proportionOfHeight (0.0552f) + 175) + 72, 400, 24);
    startTimeLabel->setBounds ((getWidth() / 2) + -104 - 202, (proportionOfHeight (0.0552f) + 175) + 46, 202, 24);
    startTimeText->setBounds ((getWidth() / 2) + -100, (proportionOfHeight (0.0552f) + 175) + 46, 400, 24);
    lengthLabel->setBounds ((getWidth() / 2) + -104 - 202, (proportionOfHeight (0.0552f) + 175) + 20, 202, 24);
    lengthText->setBounds ((getWidth() / 2) + -100, (proportionOfHeight (0.0552f) + 175) + 20, 400, 24);
    level1->setBounds (44, proportionOfHeight (0.0552f), 150, 24);
    level2->setBounds (44, proportionOfHeight (0.0552f) + 175, 150, 24);
    licenseLabel->setBounds ((getWidth() / 2) + -104 - 202, proportionOfHeight (0.0552f) + 142, 202, 24);
    licenseEditor->setBounds ((getWidth() / 2) + -100, proportionOfHeight (0.0552f) + 136, 350, 34);
    shadow->setBounds (0, 0, 5, getHeight() - 0);
    separator1->setBounds ((getWidth() / 2) + -57 - (300 / 2), (proportionOfHeight (0.0552f) + 7) + 31, 300, 4);
    separator2->setBounds ((getWidth() / 2) + -57 - (300 / 2), (proportionOfHeight (0.0552f) + 54) + 31, 300, 4);
    separator3->setBounds ((getWidth() / 2) + -57 - (300 / 2), (proportionOfHeight (0.0552f) + 100) + 31, 300, 4);
...
<JUCER_COMPONENT documentType="Component" className="ProjectPagePhone" template="../../Template"
  ...
  <GENERICCOMPONENT name="level1" id="b6ea6ccc6b9be1f8" memberName="level1" virtualName=""
                    explicitFocusOrder="0" pos="44 5.524% 150 24" class="Component"
                    params=""/>
