...
TrackStartIndicator::TrackStartIndicator()
    : absPosition(0)
{
    addAndMakeVisible (shadow = new ShadowLeftwards());
...
void TrackStartIndicator::resized()
{
...
void TrackStartIndicator::parentHierarchyChanged()
{
...
void TrackStartIndicator::parentSizeChanged()
{
...
<JUCER_COMPONENT documentType="Component" className="TrackStartIndicator" template="../../../Template"
