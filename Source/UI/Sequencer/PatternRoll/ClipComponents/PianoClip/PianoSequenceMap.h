...
class PianoSequenceMap :
    public virtual Component,
    public ProjectListener
{
public:

    PianoSequenceMap(ProjectTreeItem &project, MidiSequence *sequence, HybridRoll &roll);
    ~PianoSequenceMap() override;
...
private:
    ...
    JUCE_LEAK_DETECTOR(PianoSequenceMap)
};
