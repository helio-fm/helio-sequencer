...
class AutomationStepsSequenceMap : public Component, public ProjectListener
{
public:
    
    AutomationStepsSequenceMap(ProjectTreeItem &parentProject,
        HybridRoll &parentRoll, WeakReference<MidiSequence> targetLayer);
    
    ~AutomationStepsSequenceMap() override;
...
private:
    ...
    void updateEventComponent(AutomationStepEventComponent *component);
    void reloadTrack();
