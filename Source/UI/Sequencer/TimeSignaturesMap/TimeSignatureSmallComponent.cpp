...
TimeSignatureSmallComponent::TimeSignatureSmallComponent(TimeSignaturesTrackMap<TimeSignatureSmallComponent> &parent, const TimeSignatureEvent &targetEvent)
    : event(targetEvent),
      editor(parent)
{
...
<JUCER_COMPONENT documentType="Component" className="TimeSignatureSmallComponent"
                 ...
                 constructorParams="TimeSignaturesTrackMap&lt;TimeSignatureSmallComponent&gt; &amp;parent, const TimeSignatureEvent &amp;targetEvent"
  ...
  <LABEL name="" id="3dbd8cef4b61c2fe" memberName="signatureLabel" virtualName=""
         explicitFocusOrder="0" pos="0 4 -16M 16" textCol="77ffffff" edTextCol="ff000000"
