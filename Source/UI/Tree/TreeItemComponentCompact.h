...
class TreeItemComponentCompact : public TreeItemComponent
{
public:

    explicit TreeItemComponentCompact(TreeItem &i);
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TreeItemComponentCompact);
