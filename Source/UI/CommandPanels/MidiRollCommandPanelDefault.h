...
class MidiRollCommandPanelDefault  : public MidiRollCommandPanel
{
public:

    MidiRollCommandPanelDefault (ProjectTreeItem &parent);

    ~MidiRollCommandPanelDefault();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MidiRollCommandPanelDefault)
};
