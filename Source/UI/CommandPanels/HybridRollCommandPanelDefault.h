...
class HybridRollCommandPanelDefault  : public HybridRollCommandPanel
{
public:

    HybridRollCommandPanelDefault (ProjectTreeItem &parent);

    ~HybridRollCommandPanelDefault();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (HybridRollCommandPanelDefault)
};
