    ...
    : title(headerTitle)
{
    ...
    detailsLabel->setJustificationType (Justification::centredRight);
    ...
    addAndMakeVisible (backButton = new RolloverBackButtonRight());
...
RolloverHeaderRight::~RolloverHeaderRight()
{
    //[Destructor_pre]
    //[/Destructor_pre]
...
void RolloverHeaderRight::paint (Graphics& g)
{
...
void RolloverHeaderRight::resized()
{
    //[UserPreResize] Add your own custom resize code here..
    //[/UserPreResize]

    shade->setBounds (0, 0, getWidth() - 0, getHeight() - 0);
    titleLabel->setBounds (getWidth() - 47 - (getWidth() - 88), (getHeight() / 2) + -10 - (24 / 2), getWidth() - 88, 24);
    detailsLabel->setBounds (getWidth() - 48 - (getWidth() - 88), (getHeight() / 2) + 10 - (24 / 2), getWidth() - 88, 24);
    backButton->setBounds (getWidth() - 15 - 32, (getHeight() / 2) - (32 / 2), 32, 32);
    //[UserResized] Add your own custom resize handling here..
    //[/UserResized]
}

void RolloverHeaderRight::handleCommandMessage (int commandId)
{
...
void RolloverHeaderRight::mouseDown (const MouseEvent& e)
{
...
<JUCER_COMPONENT documentType="Component" className="RolloverHeaderRight" template="../../Template"
  ...
  <LABEL name="" id="caeb9c984a0dbed5" memberName="titleLabel" virtualName=""
         explicitFocusOrder="0" pos="47Rr -10Cc 88M 24" textCol="ffffffff"
         edTextCol="ff000000" edBkgCol="0" labelText="..." editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="17" kerning="0" bold="0" italic="0" justification="34"/>
  <LABEL name="" id="daf4204f5a799225" memberName="detailsLabel" virtualName=""
         explicitFocusOrder="0" pos="48Rr 10Cc 88M 24" textCol="77ffffff"
         edTextCol="ff000000" edBkgCol="0" labelText="..." editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
  ...
  <JUCERCOMP name="" id="6cc5b3a24299058e" memberName="backButton" virtualName=""
             explicitFocusOrder="0" pos="15Rr 0Cc 32 32" sourceFile="RolloverBackButtonRight.cpp"
             constructorParams=""/>
</JUCER_COMPONENT>
