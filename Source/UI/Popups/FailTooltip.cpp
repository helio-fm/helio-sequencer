...
void FailTooltip::paint (Graphics& g)
{
...
void FailTooltip::parentHierarchyChanged()
{
...
<JUCER_COMPONENT documentType="Component" className="FailTooltip" template="../../Template"
