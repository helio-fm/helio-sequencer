...
void HeadlineItemArrow::paint (Graphics& g)
{
    ...
    {
        float x = 0, y = 0;
        Colour fillColour1 = Colour (0x25000000), fillColour2 = Colour (0x00000000);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setGradientFill (ColourGradient (fillColour1,
                                       static_cast<float> (getWidth() - 18) - 0.0f + x,
...
void HeadlineItemArrow::resized()
{
    ...
    internalPath1.lineTo (32.0f, 0.0f);
...
<JUCER_COMPONENT documentType="Component" className="HeadlineItemArrow" template="../../Template"
  ...
  <BACKGROUND backgroundColour="0">
    <PATH pos="0 0 100 100" fill=" radial: 18R 0C, 0R 0C, 0=25000000, 1=0"
          hasStroke="0" nonZeroWinding="1">s 16R 0 l 32 0 l 0R 0R l 16R 0R l 9R 0C x</PATH>
