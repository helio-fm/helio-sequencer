...
CommandIDs::Id CommandIDs::getIdForName(const String &command)
{
    switch (constexprHash(command.toRawUTF8()))
    {
        ...
        CASE_FOR(EditCurrentInstrumentRouting)
        CASE_FOR(EditCurrentInstrumentKeymap)
        ...
        CASE_FOR(ToggleShowMidiNumbers)
        ...
        CASE_FOR(TransportFastPlaybackStart)
        ...
        CASE_FOR(ScriptEditorDismiss)
        CASE_FOR(ScriptEditorRunScript)
...
I18n::Key CommandIDs::getTranslationKeyFor(CommandIDs::Id id)
{
    ...
    switch (id)
    {
        ...
        TRANS_KEY(InstanceToUniqueTrack, Menu::trackMakeUnique)
        TRANS_KEY(EditCurrentInstrument, Menu::instrumentShowWindow)
        TRANS_KEY(EditCurrentInstrumentRouting, Menu::instrumentShowEditor)
        TRANS_KEY(EditCurrentInstrumentKeymap, Menu::keyboardMappingEdit)
        ...
        TRANS_KEY(ToggleScalesHighlighting, Settings::scalesHighlighting)
        TRANS_KEY(ToggleNoteNameGuides, CommandPalette::toggleNoteNameGuides)
        TRANS_KEY(ToggleShowMidiNumbers, Settings::showMidiNumbers)
        ...
        //TRANS_NONE(TransportFastPlaybackStart)
        ...
        TRANS_KEY(JoinAdjacent, Menu::Refactor::joinAdjacent)
        ...
        TRANS_KEY(ScriptEditor, Tooltips::scriptEditor)
        ...
        //TRANS_NONE(ScriptEditorDismiss)
        //TRANS_NONE(ScriptEditorRunScript)
