...
CommandIDs::Id CommandIDs::getIdForName(const String &command)
{
    switch (constexprHash(command.toRawUTF8()))
    {
        ...
        CASE_FOR(DismissCallout)
        CASE_FOR(DismissDialog)
...
I18n::Key CommandIDs::getTranslationKeyFor(CommandIDs::Id id)
{
    ...
    switch (id)
    {
        ...
        TRANS_NONE(DismissCallout)
        TRANS_NONE(DismissDialog)
        ...
        TRANS_NONE(TrackSetOneTempo)
        TRANS_NONE(TempoUp1Bpm)
        TRANS_NONE(TempoDown1Bpm)
        TRANS_NONE(SelectScaleDegree)
        ...
        TRANS_NONE(TransposeUp)
        TRANS_NONE(TransposeDown)
        TRANS_KEY(TransposeScaleKeyUp, Menu::refactoringInScaleTransposeUp)
        TRANS_KEY(TransposeScaleKeyDown, Menu::refactoringInScaleTransposeDown)
        TRANS_NONE(TransposeOctaveUp)
        TRANS_NONE(TransposeOctaveDown)
        TRANS_NONE(TransposeFifthUp)
        TRANS_NONE(TransposeFifthDown)
        TRANS_NONE(MakeStaccato)
        TRANS_NONE(MakeStaccatissimo)
        TRANS_NONE(MakeLegato)
