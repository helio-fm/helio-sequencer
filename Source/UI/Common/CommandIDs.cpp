...
Identifier CommandIDs::getTranslationKeyFor(CommandIDs::Id id)
{
    switch (id)
    {
        ...
        TRANS_KEY(ToggleMuteClips, Menu::muteToggle)
        TRANS_KEY(ToggleSoloClips, Menu::soloToggle)
        TRANS_NONE(ZoomIn)
        TRANS_NONE(ZoomOut)
        TRANS_KEY(ZoomEntireClip, Menu::Selection::clipsEdit)
        TRANS_NONE(Undo)
        TRANS_NONE(Redo)
        TRANS_NONE(ShowAnnotations)
        ...
        TRANS_NONE(BarShiftLeft)
        TRANS_NONE(BarShiftRight)
