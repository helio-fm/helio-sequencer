...
#include "RolloverBackButtonRight.h"

//[MiscUserDefs]
#include "TreePanel.h"
//[/MiscUserDefs]

RolloverBackButtonRight::RolloverBackButtonRight()
{
...
void RolloverBackButtonRight::paint (Graphics& g)
{
...
void RolloverBackButtonRight::resized()
{
...
void RolloverBackButtonRight::mouseDown (const MouseEvent& e)
{
...
<JUCER_COMPONENT documentType="Component" className="RolloverBackButtonRight"
